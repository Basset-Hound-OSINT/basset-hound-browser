/**
 * Basset Hound Browser - Proxy Manager (base layer)
 *
 * ProxyManagerBase: single-proxy configuration, validation, rotation,
 * authentication, and stats. Code moved verbatim from proxy/manager.js
 * (2026-07-04 modularization).
 *
 * @module proxy/manager/proxy-manager-base
 */
  ...
  getProxyStatus() {
    const status = {
      ...
      currentProxy: this.currentProxy ? {
        ...
        port: this.currentProxy.port,
        type: this.currentProxy.type,
        hasAuth: Boolean(this.currentProxy.auth)
      } : null,
      rotation: {
...
module.exports = ProxyManagerBase;
